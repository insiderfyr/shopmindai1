...
const FeaturesSection = memo(function FeaturesSection() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      { 
        threshold: 0.1,
        rootMargin: '50px' // Start animation earlier for smoother UX
      }
    )
    ...
    return () => observer.disconnect() // More efficient cleanup
  }, [])

  // Move features data outside component to prevent recreation
  const features = [
    {
      icon: Sparkles,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => {
            ...
            return (
              <article
                key={feature.title} // Use stable key
