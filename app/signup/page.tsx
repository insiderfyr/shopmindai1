      ...
      <div className="w-full max-w-sm">
        <div className="bg-white rounded-2xl shadow-2xl px-8 py-8 w-full">
          ...
          <div className="text-center mb-6">
            <h1 className="text-lg font-medium text-gray-800 mb-1">Create your account</h1>
            <p className="text-sm text-gray-500">Sign up with your email or Google account.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                } rounded-lg focus:ring-2 focus:ring-[#4d8eff] focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white text-sm`}
          ...
          <div className="text-center mt-4">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/auth" className="text-[#4d8eff] hover:underline font-medium">
                Log in
              </Link>
            </p>
          </div>
          ...
          <p className="text-xs text-gray-400 text-center mt-6 leading-relaxed">
            ...
            <Link href="/terms" className="text-[#4d8eff] hover:underline">
              Terms of Service
            </Link>{" "}
            and{" "}
